...
class DAOPlantacao{
  ...
  public function queryInsert(Plantacao $plantacao){
    ...
    $t_sql -> bindValue(":nome", $plantacao->nome);
  ...
  public function querySelectAll(){
    try {
      $sql = "SELECT * FROM plantacao ORDER BY plantacao.id";
  ...
  public function querySelectFromUser(Plantacao $plantacao){
    try {
      $sql = "SELECT * FROM plantacao WHERE usuario_id = :user_id";
      $t_sql = $this->pdo->prepare($sql);
  ...
  public function queryDelete(Plantacao $plantacao){
    try {
      $sql = "DELETE FROM plantacao WHERE id = :id";
      $t_sql = $this->pdo->prepare($sql);
      $t_sql -> bindValue(":id", $plantacao->id);
      return $t_sql->execute();
    } catch (PDOException $e) {
